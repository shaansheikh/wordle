// This is bad hacky code, don't look at it

wordDate = new Date;
this.wordle = this.wordle || {},
mainFunct = function(e) {
    //debugger;
    "use strict";
    function a(e) {
    ...
    // done
    gameTileElement.innerHTML = /*html*/`
    <style>
      :host {
    ...
    var gameRow = function(e) {
        ...
        return o(t, [{
            ...
            value: function() {
                var e = this;
                this.shadowRoot.appendChild(gameRowElement.content.cloneNode(!0)),
    ...
    var gameThemeManagerElement = document.createElement("template");
    gameThemeManagerElement.innerHTML = "\n  <slot></slot>\n";
    var j = "darkTheme"
      , S = "colorBlindTheme"
      , gameThemeManager = function(e) {
        ...
        return o(t, [{
            ...
            value: function() {
                var e = this;
                this.shadowRoot.appendChild(gameThemeManagerElement.content.cloneNode(!0)),
    ...
    var gameSettingElement = document.createElement("template");
    gameSettingElement.innerHTML = /*html*/`
      <style>
      .setting {
            display: flex;
    ...
    var gameSetting = function(e) {
        ...
        return o(t, [{
            ...
            value: function() {
                var e, a = this;
                this.shadowRoot.appendChild(gameSettingElement.content.cloneNode(!0)),
    ...
    customElements.define("game-settings", gameSetting);
    var gameToastElement = document.createElement("template");
    gameToastElement.innerHTML = /*html*/`
      <style>
        .toast {
              position: relative;
              margin: 16px;
    ...
    var Ea, gameToast = function(e) {
        ...
        return o(t, [{
            ...
            value: function() {
                var e = this;
                this.shadowRoot.appendChild(gameToastElement.content.cloneNode(!0));
    ...
    var firstWordle = new Date(2021,5,19,0,0,0,0);
    function subtractTwoDates(e, a) {
        var s = new Date(e)
          , t = new Date(a).setHours(0, 0, 0, 0) - s.setHours(0, 0, 0, 0);
        return Math.round(t / 864e5)
    }
    function getSolutionForDay(e) {
        var a, s = OffsetForDay(e);
        return a = s % solutionArray.length,
        solutionArray[a]
    }
    function OffsetForDay(e) {
        return subtractTwoDates(firstWordle, e)
    }
    ...
    gameAppElement.innerHTML = /*html*/`
        ...
        .datePickerItem:hover {
            background-color: var(--color-tone-5);
        }
        .datePickerItem.selected {
        ...
        <div id="game">
            <header>
                <div class="menu">
                    <button id="home-button" class="icon" aria-label="home">
                        <game-icon icon="home"></game-icon>
                    </button>
                    <button id="help-button" class="icon" aria-label="help">
                        <game-icon icon="help"></game-icon>
                    </button>
                </div>
                <div id="top-title" class="title main-title">
                    WORDLE
                </div>
                <div class="menu">
            ...
            <div id="date-picker">
                <div id="year-column" class="date-column column-border opening"></div>
                <div id="month-column" class="date-column column-border"></div>
                <div id="day-column" class="date-column "></div>
            </div>
            <div id="main-menu">
                <div id="giant-title" class="title main-title">
                    WORDLE
                </div>
                <button id="play-yesterday" class="menu-button">Yesterday's Wordle</button>
                <button id="play-today" class="menu-button">Today's Wordle</button>
                <button id="play-tomorrow" class="menu-button">Tomorrow's Wordle</button>
                <button id="play-random" class="menu-button">Random Wordle <game-icon icon="dice" fillcolor="var(--white)"</button>
                <button id="choose-date" class="menu-button">All Wordles <game-icon icon="calendar" fillcolor="var(--white)"></game-icon></button>
            </div>
    ...
    `;
    var debugToolsElement = document.createElement("template");
    debugToolsElement.innerHTML = /*html*/`
    ...
    `;
    var stateInProgress = "IN_PROGRESS"
      , stateWin = "WIN"
      , stateFail = "FAIL"
      , compliments = ["Genius", "Magnificent", "Impressive", "Splendid", "Great", "Phew"]
      , gameApp = function(e) {
        r(t, e);
        var a = h(t);
        function t() {
            ...
            n(p(e), "canInput", !0),
            n(p(e), "gameStatus", stateInProgress),
            ...
            !e.lastPlayedTs || subtractTwoDates(new Date(e.lastPlayedTs), e.today) >= 0 ? (
        ...
        return o(t, [{
            ...
            value: function() {
                if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
                    ...
                    if (e = s,
                    !allGuessesArray.includes(e) && !solutionArray.includes(e))
                    ...
                    if (i || l)
                        Va({
                            isWin: l,
                            isStreak: !!this.lastCompletedTs && 1 === subtractTwoDates(new Date(this.lastCompletedTs), new Date),
                            numGuesses: this.rowIndex
                        }),
                        ja({
                            lastCompletedTs: Date.now()
                        }),
                        this.gameStatus = l ? stateWin : stateFail;
                    this.tileIndex = 0,
                    this.canInput = !1,
                    ja({
            ...
            key: "addLetter",
            value: function(e) {
                this.gameStatus === stateInProgress && (this.canInput && (this.tileIndex >= 5 || (this.boardState[this.rowIndex] += e,
            ...
            key: "removeLetter",
            value: function() {
                if (this.gameStatus === stateInProgress && this.canInput && !(this.tileIndex <= 0)) {
            ...
            key: "submitGuess",
            value: function() {
                if (this.gameStatus === stateInProgress && this.canInput) {
                    if (5 !== this.tileIndex)
            ...
            value: function() {
                ...
                this.gameStatus === stateWin && this.rowIndex <= 6 && a.setAttribute("highlight-guess", this.rowIndex),
                a.gameApp = this,
                e.appendChild(a),
                e.setAttribute("open", "")
            }
            ...
            key: "startGame",
            value: function(wordDate, solution = undefined) {
                this.page = "game";
                this.boardState = new Array(6).fill(""),
                this.evaluations = new Array(6).fill(null),
                this.gameStatus = stateInProgress,
                this.rowIndex = 0,
                this.tileIndex = 0,
                this.canInput = !0,
                this.wordDate = wordDate;
                if (!solution) {
                    this.solution = getSolutionForDay(wordDate);
                    this.isCustomWord = false;
                } else {
                    this.solution = solution;
                    this.isCustomWord = true;
                    if (!allGuessesArray.includes(solution) && !solutionArray.includes(solution)) {
                        allGuessesArray.push(solution);
                    }
                }
                this.dayOffset = OffsetForDay(wordDate),
                this.shadowRoot.getElementById("main-menu").style.display = "none";
                this.shadowRoot.getElementById("top-title").style.display = "block";
                this.shadowRoot.getElementById("top-title").classList.add("fadingIn");

                var boardContainerElement = document.createElement('div');
                boardContainerElement.setAttribute('id', 'board-container');
                boardContainerElement.setAttribute('class', 'opening');
                var boardElement = document.createElement('div');
                boardElement.setAttribute('id', 'board');
                boardContainerElement.appendChild(boardElement);
                this.$game.appendChild(boardContainerElement);
                
                var keyboardElement = document.createElement("game-keyboard");
                keyboardElement.classList.add("opening")
                this.$game.appendChild(keyboardElement);
            ...
            value: function() {
                ...
                switch(this.page) {
                    case "home":
                        return
                    case "game":
                        this.shadowRoot.getElementById("board-container").classList.remove("opening");
                        this.shadowRoot.getElementById("board-container").classList.add("closing");
                        this.$keyboard.classList.remove("opening");
                        this.$keyboard.classList.add("closing");
                        break;
                    case "calendar":
                        this.shadowRoot.getElementById("date-picker").style.display = "none";
                        this.shadowRoot.getElementById("year-column").innerHTML = '';
                        this.shadowRoot.getElementById("month-column").innerHTML = '';
                        this.shadowRoot.getElementById("day-column").innerHTML = '';
                        this.shadowRoot.getElementById("main-menu").style.display = "block";
                        this.shadowRoot.getElementById("main-menu").classList.add("fadingIn-fast");
                        break;
                }
                this.shadowRoot.getElementById("top-title").classList.remove("fadingIn");
                this.shadowRoot.getElementById("top-title").classList.add("fadingOut");
            ...
            key: "arriveHome",
            value: function() {
                this.shadowRoot.getElementById("board-container").remove();
                this.$keyboard.remove();
                this.$board = undefined;
                this.$keyboard = undefined;
                this.shadowRoot.getElementById("main-menu").style.display = "block";
                this.shadowRoot.getElementById("main-menu").classList.add("fadingIn-fast");
                this.shadowRoot.getElementById("top-title").style.display = "none"; 
                this.shadowRoot.getElementById("top-title").classList.remove("fadingOut");
                this.page = "home"  
            }
        }, {
            key: "chooseDate",
            ...
            value: function() {
                this.page = "calendar";
                this.shadowRoot.getElementById("date-picker").style.display = "flex";
                var e = this;

                var today = new Date;
                var selectedYear = today.getFullYear();
                var selectedMonth = today.getMonth();
                var lastWordle = new Date(firstWordle.getTime() + solutionArray.length * 864e5);

                var dayColumn = this.shadowRoot.getElementById("day-column");

                function generateDates() {
                    dayColumn.innerHTML = '';
                    var currentDate = new Date(selectedYear, selectedMonth, 1);
                    while (currentDate.getMonth() == selectedMonth) {
                        if (currentDate >= firstWordle && currentDate <= lastWordle) {
                            var node = datePickerTemplate.content.cloneNode(true);
                            var datePickerItem = node.querySelector('.datePickerItem');
                            datePickerItem.setAttribute('year', currentDate.getFullYear());
                            datePickerItem.setAttribute('month', currentDate.getMonth());
                            datePickerItem.setAttribute('day', currentDate.getDate());

                            var dateHolder = node.querySelector('.datePickerText');
                            dateHolder.classList.add('date');
                            dateHolder.classList.remove('datePickerText');

                            var badge = document.createElement('div');
                            badge.classList.add('badge');
                            dateHolder.appendChild(badge);
                            badge.textContent = currentDate.getDate();

                            if (selectedYear == today.getFullYear() && selectedMonth == today.getMonth() && currentDate.getDate() == today.getDate() ) {
                                badge.classList.add('badge-today');
                                var todayNode = badge;
                            }

                            var puzzleNumber = document.createElement('div');
                            puzzleNumber.setAttribute('class', 'puzzle-number');
                            puzzleNumber.textContent = '#' + OffsetForDay(currentDate);
                            datePickerItem.appendChild(puzzleNumber);

                            var solutionHolder = document.createElement('div');
                            solutionHolder.setAttribute('class', 'solution');
                            solutionHolder.textContent = 'abbey';
                            datePickerItem.appendChild(solutionHolder);

                            var guesses = document.createElement('div');
                            guesses.setAttribute('class', 'guesses');
                            guesses.textContent = '3/6';
                            datePickerItem.appendChild(guesses);

                            dayColumn.appendChild(node);
                        }
                        currentDate.setDate(currentDate.getDate() + 1);
                    }
                    if (todayNode != null) {
                        todayNode.scrollIntoView({block: "center"});
                    }
                }
                var clickItemFn = function(a) {
                    var s = a.target.closest(".datePickerItem");
                    if (s != null) {
                        if (s.hasAttribute('month')) {
                            selectedMonth = s.getAttribute('month');
                        } else {
                            selectedYear = s.textContent;
                        }
                        var currentlySelected = s.parentNode.querySelector('.selected')
                        if (currentlySelected != null && currentlySelected != s) {
                ...
                var clickDateFn = function(a) {
                    var s = a.target.closest(".datePickerItem");
                    if (s != null) {
                        var clickedDate = new Date(s.getAttribute('year'), s.getAttribute('month'), s.getAttribute('day'));
                        console.log(clickedDate);
                        e.addToast("Work in progress", 2000);
                    }
                }

                var datePickerTemplate = document.createElement('template');
                datePickerTemplate.innerHTML = /*html*/`
                    <div class="datePickerItem">
                        <div class="datePickerText"></div>
                        <div class="chevron-holder">
                            <game-icon icon="chevron"></game-icon>
                        </div>
                    </div>
                `;

                var yearColumn = this.shadowRoot.getElementById("year-column");
                for (var year=firstWordle.getFullYear(); year <= lastWordle.getFullYear(); year++) {
                    var node = datePickerTemplate.content.cloneNode(true);
                    node.querySelector('.datePickerText').textContent = year;
                    if (year == selectedYear) {
                        node.querySelector('.datePickerItem').classList.add("selected");
                    }
                    yearColumn.appendChild(node);
                }

                const monthNames = ["January", "February", "March", "April", "May", "June",
                "July", "August", "September", "October", "November", "December"
                ];
                var monthColumn = this.shadowRoot.getElementById("month-column");
                for (var month=0; month < 12; month++) {
                    var node = datePickerTemplate.content.cloneNode(true);
                    node.querySelector('.datePickerText').textContent = monthNames[month];
                    node.querySelector('.datePickerItem').setAttribute('month', month);
                    if (month == selectedMonth) {
                        node.querySelector('.datePickerItem').classList.add("selected");
                    }
                    monthColumn.appendChild(node);
                }

                if (!this.dateListenersSetUp) {
                    yearColumn.addEventListener("click", clickItemFn);
                    monthColumn.addEventListener("click", clickItemFn);
                    dayColumn.addEventListener("click", clickDateFn);
                    this.dateListenersSetUp = true;
                }
                generateDates();
            }
        }, {
            ...
            value: function() {
                ...
                var e = this;
                this.dateListenersSetUp = false;
                this.page = "home",
                this.shadowRoot.appendChild(gameAppElement.content.cloneNode(!0)),
                ...
                this.$game.addEventListener("game-last-tile-revealed-in-row", (function(a) {
                    ...
                    (a.path || a.composedPath && a.composedPath()).includes(s) && ([stateWin, stateFail].includes(e.gameStatus) && (e.restoringFromLocalStorage ? e.showStatsModal() : (e.gameStatus === stateWin && (s.setAttribute("win", ""),
                    e.addToast(compliments[e.rowIndex - 1], 2e3)),
                    e.gameStatus === stateFail && e.addToast(e.solution.toUpperCase(), 4000),
                    setTimeout((function() {
                        e.showStatsModal()
                    }
                    ), 2500))),
                ...
                this.shadowRoot.getElementById("home-button").addEventListener("click", (function(a) {
                    e.goHome();
                })),
                ...
                this.shadowRoot.getElementById("play-yesterday").addEventListener("click", (function(a) {
                    var wordDate = new Date;
                    wordDate.setTime(wordDate.getTime() - 864e5)
                    e.startGame(wordDate)
                })),
                this.shadowRoot.getElementById("play-today").addEventListener("click", (function(a) {
                    e.startGame(new Date)
                })),
                this.shadowRoot.getElementById("play-tomorrow").addEventListener("click", (function(a) {
                    var wordDate = new Date;
                    wordDate.setTime(wordDate.getTime() + 864e5)
                    e.startGame(wordDate)
                })),
                this.shadowRoot.getElementById("play-random").addEventListener("click", (function(a) {
                    var solutionNumber = Math.floor(Math.random() * solutionArray.length)
                    var solutionDate = new Date(firstWordle.getTime());
                    solutionDate.setTime(solutionDate.getTime() + solutionNumber * 864e5)
                    e.startGame(solutionDate)
                })),
                this.shadowRoot.getElementById("choose-date").addEventListener("click", (function(a) {
                    e.chooseDate();
                })),
                ...
                const customWord = urlParams.get("custom");
                if (customWord) {
                    const decodedWord = atob(customWord);
                    if (decodedWord.length==5) {
                        this.startGame(new Date, decodedWord);
                    } else {
                        this.addToast("Invalid custom word", 2000);
                    }
                }
            ...
            value: function() {
                var e = this;
                this.shadowRoot.getElementById("debug-tools").appendChild(debugToolsElement.content.cloneNode(!0)),
    ...
    var gameKeyboardElement = document.createElement("template");
    gameKeyboardElement.innerHTML = /*html*/`
    <style>
        :host {
    ...
    var ds = [["q", "w", "e", "r", "t", "y", "u", "i", "o", "p"], ["-", "a", "s", "d", "f", "g", "h", "j", "k", "l", "-"], ["↵", "z", "x", "c", "v", "b", "n", "m", "←"]]
      , gameKeyboard = function(e) {
        ...
        return o(t, [{
            ...
            value: function() {
                var e = this;
                this.shadowRoot.appendChild(gameKeyboardElement.content.cloneNode(!0)),
  ...
  ***************************************************************************** */
    ...
    var gameStatesElement = document.createElement("template");
    gameStatesElement.innerHTML = /*html*/`
      <style>
        .container {
              display: flex;
              flex-direction: column;
      ...
      <div class="container">
        ...
        <div id="footer2" class="footer"></div>
      </div>
    `;
    var Ls = document.createElement("template");
    Ls.innerHTML = /*html*/`
    ...
    `;
    var buttonRow1 = document.createElement("template");
    buttonRow1.innerHTML = /*html*/`
        <div class="share">
            <button id="choose-date" class="menu-button">
                All Wordles <game-icon icon="calendar" fillcolor="var(--key-evaluated-text-color)"></game-icon>
            </button>
        </div>
        <div id="next-day" class="share"">
            <button class="menu-button">
                Next Day <game-icon icon="next" fillcolor="var(--key-evaluated-text-color)"></game-icon>
            </button>
        </div>
    `;
    var buttonRow2 = document.createElement("template");
    buttonRow2.innerHTML = /*html*/`
        <div class="share">
            <button id="home-button" class="menu-button">
                Home <game-icon icon="home" fillcolor="var(--key-evaluated-text-color)"></game-icon>
            </button>
        </div>
        <div class="share">
            <button id="share-button" class="menu-button">
                Share <game-icon icon="share" fillcolor="var(--key-evaluated-text-color)"></game-icon>
            </button>
        </div>
    `;
    var Ms = {
      ...
      , gameStats = function(e) {
        ...
        return o(t, [{
            ...
            value: function() {
                var e = this;
                this.shadowRoot.appendChild(gameStatesElement.content.cloneNode(!0));
                ...
                this.gameApp.gameStatus !== stateInProgress) {
                    var footer1 = this.shadowRoot.querySelector("#footer1")
                      , footer2 = this.shadowRoot.querySelector("#footer2")
                      , br1 = buttonRow1.content.cloneNode(!0)
                      , br2 = buttonRow2.content.cloneNode(!0);
                    footer1.appendChild(br1),
                    footer2.appendChild(br2);
                    var gameAppVar = this.gameApp;
                    this.shadowRoot.querySelector("button#share-button").addEventListener("click", (function(a) {
                        a.preventDefault(),
                        a.stopPropagation();
                        As(function(e) {
                            var a = e.evaluations
                              , offsetString = e.dayOffset
                              , guessesString = e.rowIndex
                              , hardmodeString = e.isHardMode
                              , isWinString = e.isWin
                              , r = JSON.parse(window.localStorage.getItem(j))
                              , i = JSON.parse(window.localStorage.getItem(S))
                              , shareString = "";
                            if (!gameAppVar.isCustomWord) {
                                shareString += "Wordle ".concat(offsetString);
                                console.log(gameAppVar);
                            } else {
                                shareString += "Custom Wordle \"".concat(gameAppVar.solution.toUpperCase()).concat("\"");
                            }
                            shareString += " ".concat(isWinString ? guessesString : "X", "/").concat(6),
                            hardmodeString && (shareString += "*");
                            var d = "";
                            ...
                            isWin: e.gameApp.gameStatus === stateWin
                        }), (function() {
                    ...
                    this.shadowRoot.querySelector("button#home-button").addEventListener("click", (function(a) {
                        e.gameApp.goHome();
                    })),
                    this.shadowRoot.querySelector("#next-day").addEventListener("click", (function(a) {
                        var wordDate = new Date;
                        wordDate.setTime(e.gameApp.wordDate.getTime() + 864e5);
                        e.gameApp.$board.parentNode.remove();
                        e.gameApp.$keyboard.remove();
                        e.gameApp.startGame(wordDate)
                    })),
                    this.shadowRoot.querySelector("#choose-date").addEventListener("click", (function(a) {
                        e.gameApp.chooseDate();
                    }))
                }
            }
        }]),
    ...
    var gameSwitchElement = document.createElement("template");
    gameSwitchElement.innerHTML = /*html*/`
      <style>
        :host {}
        .container {
              display: flex;
    ...
    var gameSwitch = function(e) {
        ...
        return o(t, [{
            ...
            value: function() {
                var e = this;
                this.shadowRoot.appendChild(gameSwitchElement.content.cloneNode(!0)),
    ...
    gameHelpElement.innerHTML = /*html*/`
      <style>
      .instructions {
            font-size: 14px;
            color: var(--color-tone-1)
    ...
    var gameHelp = function(e) {
        ...
        return o(t, [{
            key: "connectedCallback",
            value: function() {
                this.shadowRoot.appendChild(gameHelpElement.content.cloneNode(!0))
            }
        }]),
        t
    }(c(HTMLElement));
    ...
    gamePageElement.innerHTML = /*html*/`
        <style>
            .overlay {
                display: none;
                position: absolute;
    ...
    var gamePage = function(e) {
        ...
        return o(t, [{
            ...
            value: function() {
                var e = this;
                this.shadowRoot.appendChild(gamePageElement.content.cloneNode(!0)),
    ...
    var gameIconElement = document.createElement("template");
    gameIconElement.innerHTML = '\n  <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">\n    <path fill=var(--color-tone-3) />\n  </svg>\n';
    var Bs = {
        ...
        next: "M6,18L14.5,12L6,6M8,9.86L11.03,12L8,14.14M16,6H18V18H16",
      ...
      , gameIcon = function(e) {
        ...
        return o(t, [{
            key: "connectedCallback",
            value: function() {
                this.shadowRoot.appendChild(gameIconElement.content.cloneNode(!0));
                var e = this.getAttribute("icon");
                this.shadowRoot.querySelector("path").setAttribute("d", Bs[e]);
                var fillcolor = this.getAttribute("fillcolor");
                if (fillcolor != null) {
                    this.shadowRoot.querySelector("path").setAttribute("fill", fillcolor);
                }
    ...
    var countdownTimerElement = document.createElement("template");
    ...
    var Ys = 6e4
      ...
      , countdownTimer = function(e) {
        ...
        return o(t, [{
            ...
            value: function() {
                var e = this;
                this.shadowRoot.appendChild(countdownTimerElement.content.cloneNode(!0)),
