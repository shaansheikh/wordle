    ...
    gameAppElement.innerHTML = `
        ...
        <div id="game">
            ...
            <div id="main-menu">
                ...
                <button id="play-random" class="menu-button">Random Wordle <game-icon icon="dice" fillcolor="var(--color-tone-1)"</button>
                <button id="choose-date" class="menu-button">All Wordles <game-icon icon="calendar" fillcolor="var(--color-tone-1)"></game-icon></button>
            </div>
        ...
        return o(t, [{
            ...
            value: function() {
                if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
                    ...
                    if (e = s,
                    !Ta.includes(e) && !solutionArray.includes(e))
            ...
            key: "chooseDate",
            value: function() {
                this.addToast("Not implemented yet", 2000);
            }
        }, {
            key: "connectedCallback",
            value: function() {
                ...
                this.shadowRoot.getElementById("play-random").addEventListener("click", (function(a) {
                    ...
                    solutionDate.setDate(solutionDate.getDate() + solutionNumber)
